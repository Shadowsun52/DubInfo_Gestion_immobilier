...
//</editor-fold>
    ...
    public function jsonSerialize() {
        return [
            ...
            'prix' => $this->getPrix(),
            'prix_conseille' => $this->getPrixConseille(),
            'superficie' => $this->getSuperficeHabitable(),
            'nb_sdb' => $this->getNbSalleDeBain(),
            'cout_travaux' => $this->getCoutTravaux(),
            'reference' => $this->getReference(),
            'rendement' => $this->getRendement(),
            'show' => $this->getShowOnWeb(),
            'localisation' => $this->getLocalisation(),
            'localisation_indice' => $this->getLocalisationIndice(),
            'qualite' => $this->getQualite(),
            'qualite_indice' => $this->getQualiteIndice(),
            'dossier' => $this->getDossierRealise(),
            'nb_chambres' => count($this->getChambres()),
